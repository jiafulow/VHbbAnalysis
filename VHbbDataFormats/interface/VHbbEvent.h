...
class VHbbEvent {
  public:
    class SimpleJet {
      public:
        SimpleJet(): flavour(-99), isSemiLept(-99), isSemiLeptMCtruth(-99),
            SoftLeptpdgId(-99), SoftLeptIdlooseMu(-99), SoftLeptId95(-99),
            SoftLeptPt(-99), SoftLeptdR(-99), SoftLeptptRel(-99),
            SoftLeptRelCombIso(-99), tche(-99), tchp(-99), jpb(-99), jp(-99),
            ssvhe(-99), csv(-99), csvmva(-99), csvivf(-99), cmva(-99),
            vtxMass(-99), vtx3dL(-99), vtx3deL(-99), vtxNTracks(-99),
            vtxProb(-99), ntracks(-99), charge(-99), jecunc(-99),
      ...
      public:
        ...
        int flavour, isSemiLept, isSemiLeptMCtruth, SoftLeptpdgId,
            SoftLeptIdlooseMu, SoftLeptId95;
        ...
        // Energy fraction (relative to uncorrected jet energy)
        float chargedHadronEFraction, neutralHadronEFraction,
            chargedEmEFraction, neutralEmEFraction;
        int nConstituents;
    ...
    class MuonInfo {
      public:
        MuonInfo(): charge(-99), tIso(-99), eIso(-99), hIso(-99),
            pfChaIso(-99), pfChaPUIso(99), pfPhoIso(-99), pfNeuIso(-99),
            acop(-99), ipDb(-99), ipErrDb(-99), zPVPt(-99), zPVProb(-99),
    ...
    class ElectronInfo {
      public:
        ElectronInfo(): scEta(-99), scPhi(-99), charge(-99),
            ...
            fMVAVar_deta(-99), fMVAVar_detacalo(-99), fMVAVar_dphi(-99),
            fMVAVar_e1x5e5x5(-99), fMVAVar_eleEoPout(-99), fMVAVar_eta(-99),
            fMVAVar_etawidth(-99), fMVAVar_fbrem(-99), fMVAVar_gsfchi2(-99),
            fMVAVar_ip3d(-99), fMVAVar_kfchi2(-99), fMVAVar_kfhits(-99),
            fMVAVar_phiwidth(-99), fMVAVar_pt(-99), fMVAVar_see(-99),
            fMVAVar_spp(-99), mvaOut(-99), mvaOutTrig(-99),
            mcId(-99), mcMomId(-99), mcgMomId(-99) {
        }
      public:
        TLorentzVector p4, mcFourMomentum;
        ...
        int innerHits;
        bool isEB, isEE;
        float ipDb, ipErrDb, dxy, dz, pfPhoIsoDoubleCounted;
        float id95, id85, id80, id70, id95r, id85r, id80r, id70r;
        float fMVAVar_EoP, fMVAVar_HoE, fMVAVar_IoEmIoP,
            fMVAVar_PreShowerOverRaw, fMVAVar_R9, fMVAVar_d0, fMVAVar_deta,
            fMVAVar_detacalo, fMVAVar_dphi, fMVAVar_e1x5e5x5,
            fMVAVar_eleEoPout, fMVAVar_eta, fMVAVar_etawidth, fMVAVar_fbrem,
