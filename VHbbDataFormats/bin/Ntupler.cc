...
typedef struct {
    ...
    void reset() {
        for (int i = 0; i < MAXJ; i++) {
            ...
            csv[i]=-99;csv_nominal[i]=-99.;csv_upBC[i]=-99.;csv_downBC[i]=-99.;csv_upL[i]=-99.;csv_downL[i]=-99.;csv_nominal4p[i]=-99.;csv_upBC4p[i]=-99.;csv_downBC4p[i]=-99.;csv_nominal1Bin[i]=-99.;
